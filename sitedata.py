...
> An earthy color scheme for vim, WezTerm, Midnight Commander, ranger
> and Telegram Desktop: dark and light themes, gruvbox character,
> built in CIELAB and machine-checked to stay distinguishable under
> color blindness - minimum pairwise CIEDE2000 of {acc} between syntax
> accents and {ansi} across the 16 ANSI colors, verified against
...
- [enot-dark.tdesktop-theme]({b}enot-dark.tdesktop-theme) and
  [enot-light.tdesktop-theme]({b}enot-light.tdesktop-theme): Telegram
  Desktop themes, full palettes rendered from the spec
...
- [Install for Telegram Desktop]({b}telegram/)
